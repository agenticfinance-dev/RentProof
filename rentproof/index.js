...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.getBalance) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named getBalance');
    }
      ...
      setThreshold: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('setThreshold',
                                     ...
                                     'rentproof.compact line 10 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(t_0),
        ...
        const result_0 = this._setThreshold_0(context, partialProofData, t_0);
      ...
      proveSolvency: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('proveSolvency',
                                     'argument 1 (as invoked from Typescript)',
                                     'rentproof.compact line 14 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
  ...
  _getBalance_0(context, partialProofData) {
    ...
    const [nextPrivateState_0, result_0] = this.witnesses.getBalance(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(typeof(result_0) === 'bigint' && result_0 >= 0n && result_0 <= 18446744073709551615n)) {
      __compactRuntime.typeError('getBalance',
                                 'return value',
                                 'rentproof.compact line 8 char 1',
                                 'Uint<0..18446744073709551616>',
                                 result_0)
    }
  ...
  _setThreshold_0(context, partialProofData, t_0) {
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_6.toValue(0n),
                                                                                              alignment: _descriptor_6.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(t_0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    return [];
  }
  _proveSolvency_0(context, partialProofData) {
    const balance_0 = this._getBalance_0(context, partialProofData);
    const tmp_0 = balance_0
                  >=
...
const _dummyContract = new Contract({ getBalance: (...args) => undefined });
