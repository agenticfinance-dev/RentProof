/**
 * End-to-end smoke check for rentproof-app.
 *
...
async function main() {
  ...
  const compiledContract = CompiledContract.make('rentproof', RentProof.Contract).pipe(
    // @ts-expect-error - SDK generic typing rejects witness object shape at compile time; runtime shape matches generated contract Witnesses type
